...
func (_m *ClusterInterface) GetMigrationGroups(ctx context.Context, s string) (*v1alpha1.DellCSIMigrationGroup, error) {
	return nil, fmt.Errorf("Not implemented")
}

func (_m *ClusterInterface) UpdateMigrationGroup(ctx context.Context, group *v1alpha1.DellCSIMigrationGroup) error {
