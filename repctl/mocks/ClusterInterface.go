...
// GetVolumeSnapshotContent provides a mock function with given fields: _a0, _a1
func (_m *ClusterInterface) GetVolumeSnapshotContent(_a0 context.Context, _a1 string) (*s1.VolumeSnapshotContent, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *s1.VolumeSnapshotContent
	if rf, ok := ret.Get(0).(func(context.Context, string) *s1.VolumeSnapshotContent); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*s1.VolumeSnapshotContent)
		}
	}
...
// FilterVolumeSnapshotContents provides a mock function with given fields: _a0, _a1
func (_m *ClusterInterface) FilterVolumeSnapshotContents(_a0 context.Context, _a1 string) (*s1.VolumeSnapshotContentList, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *s1.VolumeSnapshotContentList
	if rf, ok := ret.Get(0).(func(context.Context, string) *s1.VolumeSnapshotContentList); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*s1.VolumeSnapshotContentList)
		}
	}
